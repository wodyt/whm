...
$_ADMINLANG['clients']['moveServiceUnpaidInvoices'] = "לשירות זה יש חשבוניות שלא שולמו. חשבוניות אלה יבוטלו עם העברת השירות.";
...
$_ADMINLANG['validationCom']['error']['signupUrl'] = "המערכת לא הצליחה לאחזר את כתובת האתר להרשמה. ודאו שיש לכם גישה למערכת באמצעות כתובת האתר המוגדרת של המערכת.";
